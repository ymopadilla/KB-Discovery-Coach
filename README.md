...
3. **BLAND-14.png** - Dr. Kim's photo
4. **discovery-methodology.png** - Methodology graphic (philosophy section)
5. **discovery-framework.png** - Framework graphic (retreat section)
